...
(function () {
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME = '../../../public/atividade4.data';
    var REMOTE_PACKAGE_BASE = 'atividade4.data';
    ...
    function runWithFS() {
      ...
      Module['FS_createPath']('/assets/textures', 'cube', true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency']('datafile_../../../public/atividade4.data');
      }
      Module['addRunDependency']('datafile_../../../public/atividade4.data');
  ...
  loadPackage({
    files: [
      { filename: '/assets/.DS_Store', start: 0, end: 6148, audio: 0 },
      { filename: '/assets/Ball.obj', start: 6148, end: 1051099, audio: 0 },
      { filename: '/assets/Wolf.obj', start: 1051099, end: 1252552, audio: 0 },
      { filename: '/assets/textures/Ball.png', start: 1252552, end: 1289393, audio: 0 },
      { filename: '/assets/textures/.DS_Store', start: 1289393, end: 1295541, audio: 0 },
      { filename: '/assets/textures/BallNormal.png', start: 1295541, end: 2441309, audio: 0 },
      { filename: '/assets/textures/Wolf.png', start: 2441309, end: 2539685, audio: 0 },
      { filename: '/assets/textures/WolfNormal.png', start: 2539685, end: 3685453, audio: 0 },
      { filename: '/assets/textures/cube/nx.png', start: 3685453, end: 3971175, audio: 0 },
      { filename: '/assets/textures/cube/ny.png', start: 3971175, end: 4266457, audio: 0 },
      { filename: '/assets/textures/cube/nz.png', start: 4266457, end: 4502357, audio: 0 },
      { filename: '/assets/textures/cube/pz.png', start: 4502357, end: 4738249, audio: 0 },
      { filename: '/assets/textures/cube/px.png', start: 4738249, end: 5023971, audio: 0 },
      { filename: '/assets/textures/cube/py.png', start: 5023971, end: 5331349, audio: 0 },
      { filename: '/assets/shaders/normalmapping.frag', start: 5331349, end: 5336831, audio: 0 },
      { filename: '/assets/shaders/normalmapping.vert', start: 5336831, end: 5337648, audio: 0 },
    ],
    remote_package_size: 5337648,
    package_uuid: 'b9ef5344-74d0-48f8-8430-4952d38cfd64',
  });
})();
var moduleOverrides = {};
var key;
...
var wasmBinaryFile = 'atividade4.wasm';
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    Module['asm'] = exports;
    wasmMemory = Module['asm']['Kg'];
    updateGlobalBufferAndViews(wasmMemory.buffer);
    wasmTable = Module['asm']['Vg'];
...
var asmLibraryArg = {
  ...
  Qa: _eglBindAPI,
  $a: _eglChooseConfig,
  Za: _eglCreateContext,
  Xa: _eglCreateWindowSurface,
  Ya: _eglDestroyContext,
  Wa: _eglDestroySurface,
  _a: _eglGetConfigAttrib,
  ja: _eglGetDisplay,
  Oa: _eglGetError,
  bb: _eglInitialize,
  Va: _eglMakeCurrent,
  ...
  Ig: _emscripten_exit_fullscreen,
  Na: _emscripten_exit_pointerlock,
  B: _emscripten_get_device_pixel_ratio,
  m: _emscripten_get_element_css_size,
  jb: _emscripten_get_fullscreen_status,
  Ca: _emscripten_get_gamepad_status,
  Hg: _emscripten_get_num_gamepads,
  eb: _emscripten_get_preloaded_image_data,
  db: _emscripten_get_preloaded_image_data_from_FILE,
  mg: _emscripten_glActiveTexture,
  lg: _emscripten_glAttachShader,
  md: _emscripten_glBeginQuery,
  Dg: _emscripten_glBeginQueryEXT,
  Qc: _emscripten_glBeginTransformFeedback,
  kg: _emscripten_glBindAttribLocation,
  jg: _emscripten_glBindBuffer,
  Nc: _emscripten_glBindBufferBase,
  Oc: _emscripten_glBindBufferRange,
  ig: _emscripten_glBindFramebuffer,
  hg: _emscripten_glBindRenderbuffer,
  Vb: _emscripten_glBindSampler,
  gg: _emscripten_glBindTexture,
  Nb: _emscripten_glBindTransformFeedback,
  Vc: _emscripten_glBindVertexArray,
  vg: _emscripten_glBindVertexArrayOES,
  fg: _emscripten_glBlendColor,
  eg: _emscripten_glBlendEquation,
  dg: _emscripten_glBlendEquationSeparate,
  cg: _emscripten_glBlendFunc,
  bg: _emscripten_glBlendFuncSeparate,
  _c: _emscripten_glBlitFramebuffer,
  ag: _emscripten_glBufferData,
  $f: _emscripten_glBufferSubData,
  _f: _emscripten_glCheckFramebufferStatus,
  Zf: _emscripten_glClear,
  ...
  Yf: _emscripten_glClearColor,
  Xf: _emscripten_glClearDepthf,
  Wf: _emscripten_glClearStencil,
  cc: _emscripten_glClientWaitSync,
  Vf: _emscripten_glColorMask,
  Uf: _emscripten_glCompileShader,
  Tf: _emscripten_glCompressedTexImage2D,
  rd: _emscripten_glCompressedTexImage3D,
  Sf: _emscripten_glCompressedTexSubImage2D,
  qd: _emscripten_glCompressedTexSubImage3D,
  oc: _emscripten_glCopyBufferSubData,
  Rf: _emscripten_glCopyTexImage2D,
  Qf: _emscripten_glCopyTexSubImage2D,
  sd: _emscripten_glCopyTexSubImage3D,
  Pf: _emscripten_glCreateProgram,
  Of: _emscripten_glCreateShader,
  Nf: _emscripten_glCullFace,
  Mf: _emscripten_glDeleteBuffers,
  Lf: _emscripten_glDeleteFramebuffers,
  Kf: _emscripten_glDeleteProgram,
  od: _emscripten_glDeleteQueries,
  Fg: _emscripten_glDeleteQueriesEXT,
  Jf: _emscripten_glDeleteRenderbuffers,
  Xb: _emscripten_glDeleteSamplers,
  If: _emscripten_glDeleteShader,
  dc: _emscripten_glDeleteSync,
  Hf: _emscripten_glDeleteTextures,
  Mb: _emscripten_glDeleteTransformFeedbacks,
  Uc: _emscripten_glDeleteVertexArrays,
  tg: _emscripten_glDeleteVertexArraysOES,
  Gf: _emscripten_glDepthFunc,
  Ff: _emscripten_glDepthMask,
  Ef: _emscripten_glDepthRangef,
  Df: _emscripten_glDetachShader,
  Cf: _emscripten_glDisable,
  Bf: _emscripten_glDisableVertexAttribArray,
  Af: _emscripten_glDrawArrays,
  hc: _emscripten_glDrawArraysInstanced,
  pg: _emscripten_glDrawArraysInstancedANGLE,
  Cd: _emscripten_glDrawArraysInstancedARB,
  Dd: _emscripten_glDrawArraysInstancedEXT,
  yb: _emscripten_glDrawArraysInstancedNV,
  gd: _emscripten_glDrawBuffers,
  yd: _emscripten_glDrawBuffersEXT,
  qg: _emscripten_glDrawBuffersWEBGL,
  zf: _emscripten_glDrawElements,
  gc: _emscripten_glDrawElementsInstanced,
  og: _emscripten_glDrawElementsInstancedANGLE,
  zd: _emscripten_glDrawElementsInstancedARB,
  Ad: _emscripten_glDrawElementsInstancedEXT,
  Bd: _emscripten_glDrawElementsInstancedNV,
  wd: _emscripten_glDrawRangeElements,
  yf: _emscripten_glEnable,
  xf: _emscripten_glEnableVertexAttribArray,
  ld: _emscripten_glEndQuery,
  Cg: _emscripten_glEndQueryEXT,
  Pc: _emscripten_glEndTransformFeedback,
  fc: _emscripten_glFenceSync,
  wf: _emscripten_glFinish,
  vf: _emscripten_glFlush,
  Wc: _emscripten_glFlushMappedBufferRange,
  uf: _emscripten_glFramebufferRenderbuffer,
  tf: _emscripten_glFramebufferTexture2D,
  Yc: _emscripten_glFramebufferTextureLayer,
  sf: _emscripten_glFrontFace,
  rf: _emscripten_glGenBuffers,
  pf: _emscripten_glGenFramebuffers,
  pd: _emscripten_glGenQueries,
  Gg: _emscripten_glGenQueriesEXT,
  of: _emscripten_glGenRenderbuffers,
  Yb: _emscripten_glGenSamplers,
  nf: _emscripten_glGenTextures,
  Lb: _emscripten_glGenTransformFeedbacks,
  Tc: _emscripten_glGenVertexArrays,
  sg: _emscripten_glGenVertexArraysOES,
  qf: _emscripten_glGenerateMipmap,
  mf: _emscripten_glGetActiveAttrib,
  lf: _emscripten_glGetActiveUniform,
  jc: _emscripten_glGetActiveUniformBlockName,
  kc: _emscripten_glGetActiveUniformBlockiv,
  mc: _emscripten_glGetActiveUniformsiv,
  kf: _emscripten_glGetAttachedShaders,
  jf: _emscripten_glGetAttribLocation,
  hf: _emscripten_glGetBooleanv,
  Zb: _emscripten_glGetBufferParameteri64v,
  gf: _emscripten_glGetBufferParameteriv,
  hd: _emscripten_glGetBufferPointerv,
  ff: _emscripten_glGetError,
  ef: _emscripten_glGetFloatv,
  Cc: _emscripten_glGetFragDataLocation,
  df: _emscripten_glGetFramebufferAttachmentParameteriv,
  _b: _emscripten_glGetInteger64i_v,
  ac: _emscripten_glGetInteger64v,
  Rc: _emscripten_glGetIntegeri_v,
  cf: _emscripten_glGetIntegerv,
  Ab: _emscripten_glGetInternalformativ,
  Hb: _emscripten_glGetProgramBinary,
  af: _emscripten_glGetProgramInfoLog,
  bf: _emscripten_glGetProgramiv,
  xg: _emscripten_glGetQueryObjecti64vEXT,
  zg: _emscripten_glGetQueryObjectivEXT,
  wg: _emscripten_glGetQueryObjectui64vEXT,
  jd: _emscripten_glGetQueryObjectuiv,
  yg: _emscripten_glGetQueryObjectuivEXT,
  kd: _emscripten_glGetQueryiv,
  Ag: _emscripten_glGetQueryivEXT,
  $e: _emscripten_glGetRenderbufferParameteriv,
  ...
  _e: _emscripten_glGetShaderiv,
  We: _emscripten_glGetString,
  pc: _emscripten_glGetStringi,
  $b: _emscripten_glGetSynciv,
  Ve: _emscripten_glGetTexParameterfv,
  Ue: _emscripten_glGetTexParameteriv,
  ...
  Te: _emscripten_glGetUniformfv,
  Se: _emscripten_glGetUniformiv,
  Dc: _emscripten_glGetUniformuiv,
  Jc: _emscripten_glGetVertexAttribIiv,
  Ic: _emscripten_glGetVertexAttribIuiv,
  Oe: _emscripten_glGetVertexAttribPointerv,
  Qe: _emscripten_glGetVertexAttribfv,
  Pe: _emscripten_glGetVertexAttribiv,
  Ne: _emscripten_glHint,
  Eb: _emscripten_glInvalidateFramebuffer,
  Db: _emscripten_glInvalidateSubFramebuffer,
  Me: _emscripten_glIsBuffer,
  Le: _emscripten_glIsEnabled,
  Ke: _emscripten_glIsFramebuffer,
  Je: _emscripten_glIsProgram,
  nd: _emscripten_glIsQuery,
  Eg: _emscripten_glIsQueryEXT,
  Ie: _emscripten_glIsRenderbuffer,
  Wb: _emscripten_glIsSampler,
  He: _emscripten_glIsShader,
  ec: _emscripten_glIsSync,
  Ge: _emscripten_glIsTexture,
  Kb: _emscripten_glIsTransformFeedback,
  Sc: _emscripten_glIsVertexArray,
  rg: _emscripten_glIsVertexArrayOES,
  Fe: _emscripten_glLineWidth,
  Ee: _emscripten_glLinkProgram,
  Xc: _emscripten_glMapBufferRange,
  Jb: _emscripten_glPauseTransformFeedback,
  De: _emscripten_glPixelStorei,
  Ce: _emscripten_glPolygonOffset,
  Gb: _emscripten_glProgramBinary,
  Fb: _emscripten_glProgramParameteri,
  Bg: _emscripten_glQueryCounterEXT,
  xd: _emscripten_glReadBuffer,
  Be: _emscripten_glReadPixels,
  Ae: _emscripten_glReleaseShaderCompiler,
  ze: _emscripten_glRenderbufferStorage,
  Zc: _emscripten_glRenderbufferStorageMultisample,
  Ib: _emscripten_glResumeTransformFeedback,
  ye: _emscripten_glSampleCoverage,
  Sb: _emscripten_glSamplerParameterf,
  Rb: _emscripten_glSamplerParameterfv,
  Ub: _emscripten_glSamplerParameteri,
  Tb: _emscripten_glSamplerParameteriv,
  xe: _emscripten_glScissor,
  we: _emscripten_glShaderBinary,
  ve: _emscripten_glShaderSource,
  ue: _emscripten_glStencilFunc,
  te: _emscripten_glStencilFuncSeparate,
  se: _emscripten_glStencilMask,
  re: _emscripten_glStencilMaskSeparate,
  qe: _emscripten_glStencilOp,
  pe: _emscripten_glStencilOpSeparate,
  oe: _emscripten_glTexImage2D,
  vd: _emscripten_glTexImage3D,
  ne: _emscripten_glTexParameterf,
  me: _emscripten_glTexParameterfv,
  le: _emscripten_glTexParameteri,
  ke: _emscripten_glTexParameteriv,
  Cb: _emscripten_glTexStorage2D,
  Bb: _emscripten_glTexStorage3D,
  je: _emscripten_glTexSubImage2D,
  td: _emscripten_glTexSubImage3D,
  Mc: _emscripten_glTransformFeedbackVaryings,
  ie: _emscripten_glUniform1f,
  he: _emscripten_glUniform1fv,
  ge: _emscripten_glUniform1i,
  fe: _emscripten_glUniform1iv,
  Bc: _emscripten_glUniform1ui,
  xc: _emscripten_glUniform1uiv,
  ee: _emscripten_glUniform2f,
  de: _emscripten_glUniform2fv,
  ce: _emscripten_glUniform2i,
  be: _emscripten_glUniform2iv,
  Ac: _emscripten_glUniform2ui,
  ...
  Yd: _emscripten_glUniform4f,
  Xd: _emscripten_glUniform4fv,
  Wd: _emscripten_glUniform4i,
  Vd: _emscripten_glUniform4iv,
  yc: _emscripten_glUniform4ui,
  uc: _emscripten_glUniform4uiv,
  ic: _emscripten_glUniformBlockBinding,
  Ud: _emscripten_glUniformMatrix2fv,
  fd: _emscripten_glUniformMatrix2x3fv,
  dd: _emscripten_glUniformMatrix2x4fv,
  Td: _emscripten_glUniformMatrix3fv,
  ed: _emscripten_glUniformMatrix3x2fv,
  bd: _emscripten_glUniformMatrix3x4fv,
  Sd: _emscripten_glUniformMatrix4fv,
  cd: _emscripten_glUniformMatrix4x2fv,
  ad: _emscripten_glUniformMatrix4x3fv,
  id: _emscripten_glUnmapBuffer,
  Rd: _emscripten_glUseProgram,
  ...
  ng: _emscripten_glVertexAttribDivisorANGLE,
  Ed: _emscripten_glVertexAttribDivisorARB,
  Fd: _emscripten_glVertexAttribDivisorEXT,
  zb: _emscripten_glVertexAttribDivisorNV,
  Hc: _emscripten_glVertexAttribI4i,
  Fc: _emscripten_glVertexAttribI4iv,
  Gc: _emscripten_glVertexAttribI4ui,
  Ec: _emscripten_glVertexAttribI4uiv,
  Kc: _emscripten_glVertexAttribIPointer,
  Hd: _emscripten_glVertexAttribPointer,
  Gd: _emscripten_glViewport,
  bc: _emscripten_glWaitSync,
  U: _emscripten_has_asyncify,
  mb: _emscripten_memcpy_big,
  Jg: _emscripten_request_fullscreen_strategy,
  ia: _emscripten_request_pointerlock,
  o: _emscripten_resize_heap,
  kb: _emscripten_run_script,
  Da: _emscripten_sample_gamepad_data,
  Fa: _emscripten_set_beforeunload_callback_on_thread,
  aa: _emscripten_set_blur_callback_on_thread,
  y: _emscripten_set_canvas_element_size,
  S: _emscripten_set_element_css_size,
  ba: _emscripten_set_focus_callback_on_thread,
  ...
  $c: _emscripten_set_main_loop_arg,
  ga: _emscripten_set_mousedown_callback_on_thread,
  ea: _emscripten_set_mouseenter_callback_on_thread,
  da: _emscripten_set_mouseleave_callback_on_thread,
  ha: _emscripten_set_mousemove_callback_on_thread,
  fa: _emscripten_set_mouseup_callback_on_thread,
  La: _emscripten_set_pointerlockchange_callback_on_thread,
  Ha: _emscripten_set_resize_callback_on_thread,
  ...
  Ga: _emscripten_set_visibilitychange_callback_on_thread,
  ca: _emscripten_set_wheel_callback_on_thread,
  T: _emscripten_sleep,
  vb: _emscripten_thread_sleep,
  tb: _environ_get,
  ...
  Ba: _glDrawElements,
  p: _glEnable,
  r: _glEnableVertexAttribArray,
  ud: _glFrontFace,
  F: _glGenBuffers,
  X: _glGenTextures,
  ug: _glGenVertexArrays,
  va: _glGenerateMipmap,
...
var ___wasm_call_ctors = (Module['___wasm_call_ctors'] = function () {
  return (___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['Lg']).apply(
    null,
    arguments,
  );
});
...
var _fflush = (Module['_fflush'] = function () {
  return (_fflush = Module['_fflush'] = Module['asm']['Ng']).apply(null, arguments);
});
var ___errno_location = (Module['___errno_location'] = function () {
  return (___errno_location = Module['___errno_location'] = Module['asm']['Og']).apply(
    null,
    arguments,
  );
});
...
var _fileno = (Module['_fileno'] = function () {
  return (_fileno = Module['_fileno'] = Module['asm']['Rg']).apply(null, arguments);
});
var stackSave = (Module['stackSave'] = function () {
  return (stackSave = Module['stackSave'] = Module['asm']['Sg']).apply(null, arguments);
});
var stackRestore = (Module['stackRestore'] = function () {
  return (stackRestore = Module['stackRestore'] = Module['asm']['Tg']).apply(null, arguments);
});
var stackAlloc = (Module['stackAlloc'] = function () {
  return (stackAlloc = Module['stackAlloc'] = Module['asm']['Ug']).apply(null, arguments);
});
var dynCall_viijii = (Module['dynCall_viijii'] = function () {
  return (dynCall_viijii = Module['dynCall_viijii'] = Module['asm']['Wg']).apply(null, arguments);
});
var dynCall_jiji = (Module['dynCall_jiji'] = function () {
  return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['Xg']).apply(null, arguments);
});
var dynCall_ji = (Module['dynCall_ji'] = function () {
  return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['Yg']).apply(null, arguments);
});
var dynCall_iiiiij = (Module['dynCall_iiiiij'] = function () {
  return (dynCall_iiiiij = Module['dynCall_iiiiij'] = Module['asm']['Zg']).apply(null, arguments);
});
var dynCall_iiiiijj = (Module['dynCall_iiiiijj'] = function () {
  return (dynCall_iiiiijj = Module['dynCall_iiiiijj'] = Module['asm']['_g']).apply(null, arguments);
});
var dynCall_iiiiiijj = (Module['dynCall_iiiiiijj'] = function () {
  return (dynCall_iiiiiijj = Module['dynCall_iiiiiijj'] = Module['asm']['$g']).apply(
    null,
    arguments,
  );
});
